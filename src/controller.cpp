...
)
{
	...
	// below the position control is included into vel error
    ...
    cout<<"-----POS-----"<<endl;
	cout<<"DES_P: "<<des.p<<" ODOM_P: "<<odom.p<<endl;
	cout<<"e_p: "<<e_p<<endl;
	// cout<<"K_p: "<<Kp<<endl;
	cout<<"u_p: "<<u_p<<endl;
	...
	// cout<<"e_v: "<<e_v<<endl;
	// cout<<"K_v: "<<Kv<<endl;
	// cout<<"u_v_p: "<<u_v_p<<endl;

	// use below equation if position control is not included into vel error
	u_v_p = u_v_p + u_p;

	// cout<<"u_v_p updated: "<<u_v_p<<endl;

	const std::vector<double> integration_output_limits = {0.4, 0.4, 0.4};
	Eigen::Vector3d u_v_i = wRc * Kvi * cRw * int_e_v;

	// cout<<"u_v_i: "<<u_v_i<<endl;
	...
	cout<<"-----YAW------"<<endl;
	cout<<"YAW DES: "<<yaw_des<<endl;
	cout<<"YAW CURR "<<yaw_curr<<endl;
	cout<<"YAW ERROR: "<<e_yaw<<endl;
	...
	{
		cout<<222<<endl;
		// cout<<2 * param.mass * param.gra<<endl;
		// cout<<F_des(2)<<endl;
		constraint_info = boost::str(
	...
	{	// n3 api control in forward-left-up frame
		...
		cout<<"yaw: "<<u.yaw<<endl;
		cout<<"pitch: "<<u.pitch<<endl;
		cout<<"full thrust: "<<param.full_thrust<<endl;
