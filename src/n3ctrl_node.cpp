...
int main(int argc, char* argv[]) {
    ...
    // define the param object to read parameters
    Parameter_t param;

    // define a controller with the parameters
    Controller controller(param);

    // define a hovering state with the parameters
    HovThrKF hov_thr_kf(param);

    // define a fsm with the parameters, the controller and the hovering state
