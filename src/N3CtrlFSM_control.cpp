...
void N3CtrlFSM::process_hover_control(Controller_Output_t& u, SO3_Controller_Output_t& u_so3)
{
	...
	int control_type = 0;
	controller.update(des, odom_data, u, u_so3, control_type);
...
void N3CtrlFSM::process_cmd_control(Controller_Output_t& u, SO3_Controller_Output_t& u_so3)
{
	...
	cout<<"Position: "<<endl;
	cout<<"DES_P: "<<des.p<<endl;
	cout<<"ODOM_P: "<<odom_data.p<<endl;
	// cout<<"-----------------------"<<endl;
	// cout<<"Velocity: "<<endl;
	// cout<<"DES_V: "<<des.v<<endl;
	// cout<<"ODOM_V: "<<odom_data.v<<endl;
